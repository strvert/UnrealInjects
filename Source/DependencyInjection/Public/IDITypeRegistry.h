...
UINTERFACE()
class DEPENDENCYINJECTION_API UDITypeRegistry : public UInterface
{
	GENERATED_BODY()
};

class DEPENDENCYINJECTION_API IDITypeRegistry
{
	GENERATED_BODY()
...
class DEPENDENCYINJECTION_API UDIRegisterType : public UObject
{
	GENERATED_BODY()
